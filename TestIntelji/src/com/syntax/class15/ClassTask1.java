...
public class ClassTask1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 */
		String fatherName="Daniel"; //6 characters we need first three letters thats why we divided two
		String motherName="Mariam"; // 6 characters we need first three letters thats why we divided two
		String expectation="boy";
		String firstPart="";
		String secondPart="";
		if(expectation.equalsIgnoreCase("boy")) {
			firstPart=fatherName.substring(0,fatherName.length()/2);
			secondPart=motherName.substring(0, motherName.length()/2);
			
		}else if (expectation.equalsIgnoreCase("girl")) {
			firstPart=motherName.substring(0,motherName.length()/2);
			secondPart=fatherName.substring(0, fatherName.length()/2);
		}
